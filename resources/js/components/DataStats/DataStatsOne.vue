         ...
         cardItems.value = [
            {
                ...
                total: counts.value?.tickets.pending
            },
            {
                icon: `<svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                total: counts.value?.tickets.resolved
            },
            {
                icon: `<svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                total: counts.value?.tickets.rejected
            },
            {
            ...
            `,
                ...
                total: counts.value?.tickets.processing
            ...
            },
            {
                ...
                title: 'Total Users',
                total: counts.value?.users.all_user
            ...
            `,
                title: 'Total Resolvers',
                total: counts.value?.users.resolver
            ...
            `,
                ...
                total: counts.value?.users.department
            ...
            `,
                title: 'Users are not Resolver',
                total: counts.value?.users.clean_user
