...
const img = ref('../../../storage/app/uploads/user-06.png');
      ...
      <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
        ...
        >
          <div class="relative drop-shadow-2">
            ...
            <img src="../../../storage/app/uploads/user-06.png" />
        ...
        <div class="mt-4">
          <h3 class="mb-1.5 text-2xl font-medium text-black dark:text-white">{{ adminState.name }}</h3>
          <p class="font-medium">Admin ( Issue Tracking System )</p>
          <div
