    ...
    <div class="relative w-100 sm:max-w-xl sm:mx-auto">
      ...
      >
        ...
        <div class="w-full">
          ...
          <ul>
            <li class="leading-relaxed text-[#CD5D5D]">*Please fill all the fields</li>
          </ul>
        </div>
      </div>
        ...
        <div class="max-w-md mx-auto">
          <div class="flex items-center space-x-5">
            ...
            <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
              ...
              <p class="text-sm text-gray-500 font-normal leading-relaxed">
                Can raise your issue in this ticket form
              </p>
            </div>
          </div>
          <div class="divide-y divide-gray-200">
            ...
            <div class="pt-4 flex items-center space-x-4">
              ...
              >
                Create<span class="load"><Loader v-if="loading" /></span>
              </button>
            </div>
          </div>
        </div>
...
const submitQuery = () => {
  ...
  apiClient
    .post(`/api/users/${getCookie('userId')}/tickets`, payload)
    .then((res) => {
      emit('formSubmitted')
      console.log(res)
    })
