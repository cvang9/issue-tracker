  ...
  <main v-else class="flex w-full h-full shadow-lg rounded-3xl section">
    <section class="flex flex-col w-2/12 bg-slate-800 rounded-l-3xl">
      ...
      <nav class="relative flex flex-col py-4 items-center">
        <button @click="getResolvedTickets" class="w-12 p-3 border text-gray-700 bg-white rounded-2xl mb-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <button
          ...
          class="w-12 p-3 border text-gray-700 rounded-2xl bg-white mb-4"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <button @click="getPendingTickets" class="w-12 p-3 border bg-white text-gray-700 rounded-2xl mb-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <button @click="getRejectedTickets" class="w-12 p-3 border text-gray-700 bg-white rounded-2xl mb-24">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <router-link
          ...
          class="w-16 p-4 border text-gray-700 bg-white rounded-2xl"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
